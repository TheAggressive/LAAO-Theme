		...
		<InspectorControls>
			<PanelBody title={__('Modal Settings', 'laao')} initialOpen={true}>
				...
				<TextControl
					...
					placeholder="40rem"
					onChange={(value) =>
						setAttributes({ dialogMaxWidth: value })
					}
					help={__(
				...
				{openOnLoad && (
					<ToggleControl
						...
						onChange={(value) =>
							setAttributes({ openOnLoadOnce: value })
						}
						help={__(
				...
				<ToggleControl
					...
					onChange={(value) =>
						setAttributes({ exitIntentTrigger: value })
					}
					help={__(
				...
				{exitIntentTrigger && (
					<RangeControl
						...
						onChange={(value) =>
							setAttributes({ exitIntentReshowDays: value })
						}
						min={1}
						max={90}
						step={1}
				...
				<ToggleControl
					...
					onChange={(value) =>
						setAttributes({ scrollDepthTrigger: value })
					}
					help={__(
				...
				{scrollDepthTrigger && (
					<RangeControl
						...
						onChange={(value) =>
							setAttributes({ scrollDepthPercent: value })
						}
						min={10}
						max={100}
						step={5}
			...
			{/* Close Button panel */}
			<PanelBody title={__('Close Button', 'laao')} initialOpen={false}>
				<SelectControl<string>
					...
					onChange={(value) =>
						setAttributes({ closeButtonPlacement: value })
					}
					help={
				...
				{closeButtonPlacement !== 'none' && (
					<>
						<SelectControl<string>
							...
							onChange={(value) =>
								setAttributes({ closeButtonIcon: value })
							}
							__next40pxDefaultSize
							__nextHasNoMarginBottom
						/>
						...
						<SelectControl<string>
							...
							onChange={(value) =>
								setAttributes({ closeButtonVariant: value })
							}
							__next40pxDefaultSize
							__nextHasNoMarginBottom
						/>
			...
			{!safeTriggerBlockId && (
				...
				>
					<SelectControl<string>
						...
						onChange={(value) =>
							setAttributes({ triggerVariant: value })
						}
						__next40pxDefaultSize
						__nextHasNoMarginBottom
					/>
					...
					<SelectControl<string>
						...
						onChange={(value) =>
							setAttributes({ triggerSize: value })
						}
						__next40pxDefaultSize
						__nextHasNoMarginBottom
					/>
					...
					<ToggleControl
						...
						onChange={(value) =>
							setAttributes({ triggerFullWidth: value })
						}
						help={__(
					...
					<TextControl
						...
						placeholder="0.25rem"
						onChange={(value) =>
							setAttributes({ triggerBorderRadius: value })
						}
						help={__(
			...
			{/* Modal Design panel */}
			<PanelBody title={__('Modal Design', 'laao')} initialOpen={false}>
				<p
				...
				<TextControl
					...
					placeholder="1.5rem"
					onChange={(value) =>
						setAttributes({ dialogPadding: value })
					}
					help={__(
				...
				<TextControl
					...
					onChange={(value) =>
						setAttributes({ dialogBorderRadius: value })
					}
					help={__(
